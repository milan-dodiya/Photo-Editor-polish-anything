...
import com.example.photoeditorpolishanything.Utils.CollageModelClass.ImageTemplate
...
class PhotoLayout : RelativeLayout, ItemImageView.OnImageClickListener {
    ...
    fun createImage(): Bitmap {
        ...
        {
            canvas.drawBitmap(templateImage!!, ImageUtils.createMatrixToDrawImageInCenterView(
                    mOutputScaleRatio * mViewWidth, mOutputScaleRatio * mViewHeight,
                    templateImage!!.width.toFloat(), templateImage!!.height.toFloat()), paint
            )
        }
