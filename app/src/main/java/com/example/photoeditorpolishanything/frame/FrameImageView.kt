...
import com.example.photoeditorpolishanything.Utils.GeometryUtils
...
import com.example.photoeditorpolishanything.Utils.ResultContainer
import com.example.photoeditorpolishanything.multitouch.MultiTouchHandler


import java.util.ArrayList

class FrameImageView(context: Context, val photoItem: PhotoItem) : AppCompatImageView(context) {
    ...
    var originalLayoutParams: RelativeLayout.LayoutParams
        get() {
            return if (mOriginalLayoutParams != null) {
...
//                                ).show()
    ...
    fun replaceImage(img: Bitmap?, imgPath: String?, view: FrameImageView?) {
        if (img != null && view?.image != null) {
            view.image = img
            image = img

            if (imgPath != null)
                setImagePath(imgPath)
//            Toast.makeText(context, "img replaced!", Toast.LENGTH_SHORT).show()
        }
    }

    fun replaceImage(img: Bitmap?, view: FrameImageView?) {
        if (img != null && view?.image != null) {
            view.image = img
            image = img
            ...
            view.photoItem.imagePath = photoItem.imagePath
            view.resetImageMatrix()
//            Toast.makeText(context, "img cropped!", Toast.LENGTH_SHORT).show()
        }
    }

    fun flipImage(img: Bitmap? , view: FrameImageView?) {
        if (img != null && view?.image != null) {
            view.image = img
            image = img
            ...
            view.photoItem.imagePath = photoItem.imagePath
            view.resetImageMatrix()
//            Toast.makeText(context, "img flipped!", Toast.LENGTH_SHORT).show()
        }
    }

    fun rotateImage(img: Bitmap? , view: FrameImageView?) {
        if (img != null && view?.image != null) {
            view.image = img
            image = img
            ...
            view.photoItem.imagePath = photoItem.imagePath
            view.resetImageMatrix()
//            Toast.makeText(context, "img rotated!", Toast.LENGTH_SHORT).show()
        }
    }
