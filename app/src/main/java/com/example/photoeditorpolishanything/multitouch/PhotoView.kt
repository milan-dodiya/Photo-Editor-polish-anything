...
import com.example.photoeditorpolishanything.frame.FrameTouch
import com.example.photoeditorpolishanything.frame.OnFrameTouchListener
...
import java.util.ArrayList
 ...
 class PhotoView(context: Context, attrs: AttributeSet?, defStyle: Int) : View(context, attrs, defStyle), MultiTouchController.MultiTouchObjectCanvas<MultiTouchEntity> {
    ...
    private fun init(context: Context) {
        ...
        // photocollage
        mTouchAreaInterval = res.getDimension(com.intuit.sdp.R.dimen._8sdp)
